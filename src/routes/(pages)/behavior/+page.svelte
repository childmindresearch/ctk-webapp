            ...
            <form onsubmit={onSubmit} class="space-y-6">
              ...
              <div class="space-y-3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3 ml-4">
                  <div class="flex items-center space-x-2">
                    <Checkbox id="hyper-fidgets" bind:checked={submittedFormData.hyperactivity.fidgets} />
                    <Label for="hyper-fidgets" class="font-normal">Fidgets and squirms</Label>
                  </div>
                  <div class="flex items-center space-x-2">
                    <Checkbox id="hyper-quietly" bind:checked={submittedFormData.hyperactivity.troubleQuietly} />
                    <Label for="hyper-quietly" class="font-normal">Has trouble working quietly</Label>
                  </div>
                  <div class="flex items-center space-x-2">
                    <Checkbox id="hyper-chair" bind:checked={submittedFormData.hyperactivity.getsOutOfChair} />
                    <Label for="hyper-chair" class="font-normal">Gets out of chair when not supposed to</Label>
                  </div>
                  <div class="flex items-center space-x-2">
                    <Checkbox id="hyper-runs" bind:checked={submittedFormData.hyperactivity.runsAround} />
                    <Label for="hyper-runs" class="font-normal">Runs around or climbs constantly</Label>
                  </div>
                  <div class="flex items-center space-x-2">
                    <Checkbox id="hyper-waiting" bind:checked={submittedFormData.hyperactivity.troubleWaiting} />
                    <Label for="hyper-waiting" class="font-normal">Has trouble waiting turn</Label>
                  </div>
                  <div class="flex items-center space-x-2">
                    <Checkbox id="hyper-interrupts" bind:checked={submittedFormData.hyperactivity.interrupts} />
                    <Label for="hyper-interrupts" class="font-normal">Interrupts others when they're speaking</Label>
                  </div>
                  <div class="flex items-center space-x-2 md:col-span-2">
                    <Checkbox id="hyper-talks" bind:checked={submittedFormData.hyperactivity.talksTooMuch} />
                    <Label for="hyper-talks" class="font-normal">Talks too much during and between tasks</Label>
                  </div>
                  <div class="flex items-center space-x-2 md:col-span-2">
                    <Checkbox id="hyper-blurts" bind:checked={submittedFormData.hyperactivity.blurtsAnswers} />
                    <Label for="hyper-blurts" class="font-normal">Blurts out answers before questions have been completed</Label>
                  </div>
                </div>
                <div class="space-y-2">
              ...
              <div class="space-y-3">
                ...
                <p class="text-sm text-muted-foreground ml-4">Check off which supports were provided:</p>
                <div class="space-y-2 ml-4">
                  <div class="flex items-center space-x-2">
                    <Checkbox id="support-checklist" bind:checked={submittedFormData.support.checklist} />
                  ...
                  {/if}
                  <div class="flex items-center space-x-2">
                    <Checkbox id="support-redirections" bind:checked={submittedFormData.support.redirections} />
                    <Label for="support-redirections" class="font-normal">Redirections</Label>
                  </div>
                  <div class="flex items-center space-x-2">
                    <Checkbox id="support-encouragement" bind:checked={submittedFormData.support.encouragement} />
                    <Label for="support-encouragement" class="font-normal">Encouragement</Label>
                  </div>
                  <div class="flex items-center space-x-2">
                    <Checkbox id="support-fidgets" bind:checked={submittedFormData.support.fidgets} />
