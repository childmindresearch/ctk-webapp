...
export const referralProviders = pgTable("referral_providers", {
  ...
  subServices: varchar("sub_services", { length: 255 })
    .array()
    .notNull()
    .default([]),
});
...
export const referralProviderRelations = relations(
  referralProviders,
  ({ many }) => ({
...
export const referralAddressRelations = relations(
  referralAddresses,
  ({ one }) => ({
...
export const referralFilterSetsRelations = relations(
  referralFilterSets,
  ({ one }) => ({
...
export const referralFilterGroupsRelations = relations(
  referralFilterGroups,
  ({ many }) => ({
