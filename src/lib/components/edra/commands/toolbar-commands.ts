    ...
    templates: [
        {
            ...
            tooltip: "Parent Name",
            onClick: editor => {
                editor.commands.setTemplate("parent", ["Parent Name"])
            }
        },

        {
            ...
            tooltip: "Child Name",
            onClick: editor => {
                editor.commands.setTemplate("child", ["Child Name"])
            }
        },
        {
            icon: LayoutTemplateIcon,
            ...
            tooltip: "He/She/They",
            onClick: editor => {
                editor.commands.setTemplate("pronoun-0", ["he", "she", "they", "ze"])
            }
        },
        {
            icon: LayoutTemplateIcon,
            name: "pronoun-1",
            tooltip: "Him/Her/Their",
            onClick: editor => {
                editor.commands.setTemplate("pronoun-1", ["him", "her", "their", "zir"])
            }
        },
        {
            icon: LayoutTemplateIcon,
            name: "pronoun-2",
            tooltip: "His/Her/Their",
            onClick: editor => {
                editor.commands.setTemplate("pronoun-2", ["his", "her", "their", "zir"])
            }
        },
        {
            icon: LayoutTemplateIcon,
            name: "pronoun-3",
            tooltip: "His/Hers/Theirs",
            onClick: editor => {
                editor.commands.setTemplate("pronoun-3", ["his", "hers", "theirs", "zirs"])
            }
        },
        {
            icon: LayoutTemplateIcon,
            name: "pronoun-4",
            tooltip: "Himself/Herself/Themself",
            onClick: editor => {
                editor.commands.setTemplate("pronoun-4", ["himself", "herself", "themself", "zirself"])
            }
        }
    ]
}
