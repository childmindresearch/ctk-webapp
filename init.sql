...
INSERT INTO referral_providers (name, address, phone, website, takes_insurance, description) VALUES
    ...
    ('Mindful Therapy Group', '789 Pine St, San Francisco, CA 94108', '(415) 555-0789', 'www.mindfultherapy.org', true, 'Evidence-based therapy approaches'),
    ...
    ('Golden Gate Therapy', '101 Market St, San Francisco, CA 94105', '(415) 555-0101', 'www.ggt.org', true, 'LGBTQ+ affirming care'),
    ...
    ('Sunset Mental Health', '1234 Irving St, San Francisco, CA 94122', '(415) 555-1234', 'www.sunsetmh.org', true, 'Evening and weekend appointments'),
...
INSERT INTO providers_to_areas_covered (provider_id, area_covered_id) VALUES
    (1, 1), (1, 2), (2, 2), (2, 4), (3, 1), (4, 2), (5, 3), (6, 4), (7, 1), (8, 2), (9, 3), (10, 4), (11, 1),
    (12, 2), (13, 3), (14, 4), (15, 1), (16, 2), (17, 3), (18, 4), (19, 1), (20, 2);
